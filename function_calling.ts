...
async function main(): Promise<void> {
  ...
  const context: any[] = [
    {
      role: "user",
      content:
        "What's the weather like in New York today? Please tell me in Fahrenheit, and what math you did to convert it from Celsius.",
    },
  ];
  ...
  const toolCall: any = newContext[1];
